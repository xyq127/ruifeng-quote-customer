#!/usr/bin/env node
/**
 * ruifeng-data-governance-customer install script
 *
...
const TARGETS = [
  path.join(HOME, '.claude', 'skills', 'ruifeng-data-governance-customer'),
  path.join(HOME, '.hermes', 'skills', 'ruifeng-data-governance-customer'),
];
...
console.log('ruifeng-data-governance-customer installed successfully.');
console.log('');
